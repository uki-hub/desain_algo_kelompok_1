...
class SegitigaLuas extends StatefulWidget implements BaseBasicModal {
  static const gColor = const Color(0xff957BF1);

  SegitigaLuas({Key? key}) : super(key: key);
  ...
  @override
  _SegitigaLuasState createState() => _SegitigaLuasState();
}

class _SegitigaLuasState extends State<SegitigaLuas> {
  static const String _rumusImageAsset = 'assets/images/rumus/luas_segitiga.jpg';
