...
final rumus = {
  ...
  'Alas': RumusBuilderModel(
    title: 'Alas Segitiga',
    color: Colors.blue,
    angka: [0, 0],
    angkaTextHint: ['Luas', 'Tinggi'],
    hitung: (angka) => (2 * angka[0]) / angka[1],
    rumusImageAsset: 'assets/images/rumus/luas_segitiga.jpg',
    rumusText: (angka, hasil, reg, bold) => [
      Text('((2) x ${angka[0].toPlainString()}) : ${angka[1].toPlainString()}', style: bold),
      Text('(${(2 * angka[0])} : ${angka[1].toPlainString()}) = ${hasil.toPlainString()}', style: bold),
    ],
  ),
  'Tinggi': RumusBuilderModel(
    ...
    color: Colors.blue,
    angka: [0, 0],
    angkaTextHint: ['Luas', 'Alas'],
    hitung: (angka) => (2 * angka[0]) / angka[1],
    rumusImageAsset: 'assets/images/rumus/tinggi_segitiga.jpg',
    rumusText: (angka, hasil, reg, bold) => [
      Text('((2) x ${angka[0].toPlainString()}) : ${angka[1].toPlainString()}', style: bold),
      Text('(${(2 * angka[0])} : ${angka[1].toPlainString()}) = ${hasil.toPlainString()}', style: bold),
    ],
