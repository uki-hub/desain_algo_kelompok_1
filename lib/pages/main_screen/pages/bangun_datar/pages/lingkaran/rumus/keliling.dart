...
class LingkaranKeliling extends StatefulWidget implements BaseBasicModal {
  static const gColor = const Color(0xff957BF1);

  LingkaranKeliling({Key? key}) : super(key: key);
  ...
  @override
  String get title => 'Keliling Lingkaran';

  @override
  _LingkaranKelilingState createState() => _LingkaranKelilingState();
}

class _LingkaranKelilingState extends State<LingkaranKeliling> {
  static const String _rumusImageAsset = 'assets/images/rumus/keliling_lingkaran.jpg';
    ...
    return Align(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('π x ${_angka1.toPlainString()} = ${_hasil.toPlainString()}', style: _penjelasanStyleHighlighted),
          SizedBox(height: 5),
