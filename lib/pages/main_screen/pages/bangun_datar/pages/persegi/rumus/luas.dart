...
class PersegiLuas extends StatefulWidget implements BaseBasicModal {
  static const gColor = const Color(0xff957BF1);

  PersegiLuas({Key? key}) : super(key: key);
  ...
  @override
  String get title => 'Luas Persegi';

  @override
  _PersegiLuasState createState() => _PersegiLuasState();
}

class _PersegiLuasState extends State<PersegiLuas> {
  static const String _rumusImageAsset = 'assets/images/rumus/luas_persegi.jpg';
  ...
  Widget get _rumusText {
    return Align(
      ...
      child: Column(
        ...
        children: [
          Text('${_angka1.toPlainString()}${pangkat['2']} = ${_hasil.toPlainString()}', style: _penjelasanStyleHighlighted),
          SizedBox(height: 5),
            ...
            child: CustomButton(
              ...
              onTap: () {
                ...
                if (_formKey.currentState!.validate()) {
                  ...
                  setState(() {
                    _submitted = false;
                    _hasil = pow(num.parse(_angka1!.toString()), 2).toDouble();
                  });
                }
              },
            ),
