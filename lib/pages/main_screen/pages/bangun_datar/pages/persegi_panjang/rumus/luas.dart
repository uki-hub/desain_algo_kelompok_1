...
class PersegiPanjangLuas extends StatefulWidget implements BaseBasicModal {
  static const gColor = const Color(0xff957BF1);

  PersegiPanjangLuas({Key? key}) : super(key: key);
  ...
  @override
  String get title => 'Luas Persegi Panjang';

  @override
  _PersegiPanjangLuasState createState() => _PersegiPanjangLuasState();
}

class _PersegiPanjangLuasState extends State<PersegiPanjangLuas> {
  static const String _rumusImageAsset = 'assets/images/rumus/luas_persegi_panjang.jpg';
  ...
  Widget get _rumusText {
    return Align(
      ...
      child: Column(
        ...
        children: [
          Text('(${_angka1.toPlainString()} x ${_angka2.toPlainString()} = ${_hasil.toPlainString()}', style: _penjelasanStyleHighlighted),
          SizedBox(height: 5),
